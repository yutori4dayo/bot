...
<div class="container py-3">
  ...
  <form method="post" name="" action="{{url('/serach')}}">
    @csrf
  ...
  <form class="" action="{{url('/date')}}" method="post">
    @csrf
  ...
  @foreach($imagess as $image)
    <div class="box">
        ...
        @if($image === null)
          <span></span>
        @else
        <a href="http://project1.yosiakiando.work/bot/public/img/{{$image}}"><img src="{{ asset('img/'.$image) }}"></a>
        @endif
        @endforeach
    </div>
  @endforeach
